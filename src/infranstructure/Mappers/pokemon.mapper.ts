...
import { IPokeAPIPokemon } from "../Interface/pokepi.interface";

export class PokemonMapper {
    static async pokeApiPokemonToEntity (data:IPokeAPIPokemon) :Promise<Pokemon> {
    ...
    const color = await getColorFromImage(avatar)
        ...
        return {
            ...
            moves: data.moves
              ...
              .sort((a,b) => a.level - b.level) //ordenar los pokemon
        }
    }

    static getSprites(data: IPokeAPIPokemon): string[] {
